...
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("New contact added!\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Values not accepted.\n")])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Phone number format is wrong (i.e. not a Singapore number)")]),_v(" "),_c('li',[_v("Email format is wrong (i.e. no @)")]),_v(" "),_c('li',[_v("Address format is wrong")]),_v(" "),_c('li',[_v("An existing contact with same name and phone number is found in address book")])])}
},function anonymous(
) {
...
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("List of contacts:\n")]),_c('span',[_v("...\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("No contacts added yet.\n")])])])}
},function anonymous(
) {
...
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Contact is updated!\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Values not accepted.\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Contact not found in address book\n")])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("[if applicable] Phone number format is wrong (i.e. not a Singapore number)")]),_v(" "),_c('li',[_v("[if applicable] Email format is wrong (i.e. no @)")]),_v(" "),_c('li',[_v("[if applicable] Address format is wrong")]),_v(" "),_c('li',[_v("An existing contact with same name and phone number is found in address book")])])}
},function anonymous(
) {
...
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Contacts found:\n")]),_c('span',[_v("...\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("No contact found.\n")])])])}
},function anonymous(
) {
...
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("History cleared\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("History not cleared\n")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"adding-interest-tag-interest"}},[_v("Adding interest tag : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("interest")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-interest-tag-interest","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("interest INDEX INTEREST [MORE_INTEREST]")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Adds an interest to the person at the specified 'INDEX'")]),_v(" "),_c('li',[_v("The index refers to the index number shown in the displayed person list")]),_v(" "),_c('li',[_v("The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")]),_v(" "),_c('li',[_v("The interest "),_c('strong',[_v("must not have any special characters")]),_v(" e.g. !, @, #, $, …​")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("interest 3 swimming")]),_v(" adds the interest tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("swimming")]),_v(" to the 3rd person in the address book")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("interest 1 cooking cycling")]),_v(" adds the interest tags "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cooking")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cycling")]),_v(" to the 1st person in the address book")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Tagged on contact 1\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Contact not available\n")])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"locating-persons-by-interest-findinterest"}},[_v("Locating persons by interest : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findInterest")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#locating-persons-by-interest-findinterest","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findInterest INTEREST [MORE_INTEREST]")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("The search is case-insensitive. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cooking")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cooking")])]),_v(" "),_c('li',[_v("The order of the keywords does not matter. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cycling bikes")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("bikes cycling")])]),_v(" "),_c('li',[_v("Only the interest tag is searched")]),_v(" "),_c('li',[_v("Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cycle")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cycling")])]),_v(" "),_c('li',[_v("Persons matching at least one keyword will be returned (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("OR")]),_v(" search)\ne.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ice Skating")]),_v(" will return "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ice Sculpting")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Rollor Skating")])]),_v(" "),_c('li',[_v("The interest "),_c('strong',[_v("must not have any special characters")]),_v(" e.g. !, @, #, $, …​")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findInterest swimming")]),_v(" returns "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Joseph Schooling")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Joscelin Yeo Wei Ling")]),_v(" with tags for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("swimming")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findInterest cooking cycling")]),_v(" returns "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Lance Armstrong")]),_v(" for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cycling")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Andre Chiang")]),_v(" for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cooking")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Interests found:\n")]),_c('span',[_v("...\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Interests not found\n")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Format: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addSched INDEX [MORE_INDEX] SCHEDULE_NAME from/DATE_TIME to/TIME")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("The INDEX "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")]),_v(" "),_c('li',[_v("The SCHEDULE_NAME "),_c('strong',[_v("must not have any special characters")]),_v(" e.g. !, @, #, $, …​")]),_v(" "),_c('li',[_v("The DATE_TIME must be in the format of ddmmyyyy HHmm in 24-hour time")]),_v(" "),_c('li',[_v("The TIME must be in the format of HHmm, but "),_c('strong',[_v("not before the time from DATE_TIME")]),_v(" e.g. 0000-2359")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find Betsy")]),_v(" followed by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addSched 1 Exam 05032024 1600 1800")]),_v(" adds the 1st person in\nthe results of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command to the event stated.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addSched 4 Exam 05032024 1600 1800")]),_v(" will add the 4th person in the address list to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Exam")]),_v(" event which\nwould take place on 5th March 2024 from 4pm - 6pm")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addSched 1,2,3 CSMeeting 18032024 1500 1900")]),_v(" will add the 1st, 2nd and 3rd persons in the address list\nto the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CSMeeting")]),_v(" event which would take place on 18th March 2024 from 3pm - 7pm")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Added schedule with ...\n")])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("Schedule failed to be added.\n")])])])}
},function anonymous(
) {
