...
public class NameContainsKeywordsPredicate implements Predicate<Person> {
    ...
    public boolean test(Person person) {
        Predicate<String> personName = keyword -> StringUtil.containsWordIgnoreCase(person.getName().fullName, keyword);
...
//        System.out.println(person.getTags().stream().map(tag -> tag.tagName));
        Predicate<String> combinedCondition = personName.or(personTag);
