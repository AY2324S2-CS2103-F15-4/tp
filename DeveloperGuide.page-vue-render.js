...
with(this){return _c('h3',{attrs:{"id":"add-schedule-feature"}},[_v("Add Schedule feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-schedule-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"edit-schedule-feature"}},[_v("Edit Schedule feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#edit-schedule-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"delete-schedule-feature"}},[_v("Delete Schedule feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-schedule-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("uses application to track schedule of contacts")]),_v(" "),_c('li',[_v("prefer a simple UI")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("busy student")]),_v(" "),_c('td',[_v("view my friends' schedules")]),_v(" "),_c('td',[_v("find a suitable time to plan a meetup.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("view my schedule")]),_v(" "),_c('td',[_v("know what is my plan for the day.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("categorize my friends by interests")]),_v(" "),_c('td',[_v("quickly identify individuals who share similar hobbies or preferences.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student who likes "),_c('strong',[_v("---")])]),_v(" "),_c('td',[_v("find who has similar hobbies/interests with me")]),_v(" "),_c('td',[_v("know who might want to go to a "),_c('strong',[_v("---")]),_v(" related activities with me.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student who prefers command line interface")]),_v(" "),_c('td',[_v("have a GUI to include commands")]),_v(" "),_c('td',[_v("add details with convenience")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student working part time")]),_v(" "),_c('td',[_v("utilise Moddie to store contact details for team members, advisor")]),_v(" "),_c('td',[_v("optimise my time for admin matters and focus on school and work.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("student project team leader in NUS")]),_v(" "),_c('td',[_v("check my teammates' schedule")]),_v(" "),_c('td',[_v("plan an available time for meetings with convenience")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("international NUS student")]),_v(" "),_c('td',[_v("find local friends that share similar schedules as me to aid me in easing into the university")]),_v(" "),_c('td',[_v("build meaningful connections, navigate campus life more smoothly.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("unmotivated student who needs to catch up on my studies")]),_v(" "),_c('td',[_v("manage my timetable with my friends")]),_v(" "),_c('td',[_v("easily arrange a study session with them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("freshman in NUS")]),_v(" "),_c('td',[_v("find contacts of people with similar interests as myself")]),_v(" "),_c('td',[_v("get to know them better and make friends.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS graduate")]),_v(" "),_c('td',[_v("find my lecturer’s contact email and phone number")]),_v(" "),_c('td',[_v("ask them to be a reference in my resume when applying for a job.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("save my friends tagged interest")]),_v(" "),_c('td',[_v("easily reference and remember their hobbies and preferences.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("edit my tagged interests")]),_v(" "),_c('td',[_v("keep my profile updated with my current interests and preferences")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("busy NUS student")]),_v(" "),_c('td',[_v("easily add my schedule to Moddie")]),_v(" "),_c('td',[_v("efficiently manage my academic, extracurricular, and personal commitments in one centralized platform.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("delete both my friends' and my own schedule details")]),_v(" "),_c('td',[_v("maintain privacy and control over the information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("view my friends' and their schedule details")]),_v(" "),_c('td',[_v("easily coordinate plans, schedule meetings")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student who gets confused with commands")]),_v(" "),_c('td',[_v("have an interface to assist me")]),_v(" "),_c('td',[_v("know what commands I can use")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("exit the interface")]),_v(" "),_c('td',[_v("properly close the application")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("clear my commands")]),_v(" "),_c('td',[_v("clear command messages that I do not need anymore")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS graduate")]),_v(" "),_c('td',[_v("save the contacts of my Lecturer and Tutor")]),_v(" "),_c('td',[_v("stay in touch with them after graduation.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student who makes errors")]),_v(" "),_c('td',[_v("have an interface to prompt me")]),_v(" "),_c('td',[_v("prevent myself from typing the wrong command.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student who wants to join extracurricular activities")]),_v(" "),_c('td',[_v("have a place to store my CCA events")]),_v(" "),_c('td',[_v("easily make time for them.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student who would like timetable suggestions")]),_v(" "),_c('td',[_v("see other people's schedules to see who is taking the same modules as me")]),_v(" "),_c('td',[_v("see what other modules they are also planning to take in the semester.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student pursuing an internship")]),_v(" "),_c('td',[_v("coordinate networking events and informational interviews with local professionals and industry experts")]),_v(" "),_c('td',[_v("expand my professional network and efficiently manage my academic commitments.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("course coordinator at NUS")]),_v(" "),_c('td',[_v("communicate announcements, updates, and assignment deadlines to my students")]),_v(" "),_c('td',[_v("provide a convenient channel for information dissemination and student engagement.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("NUS student")]),_v(" "),_c('td',[_v("edit my schedule, in case of any changes")]),_v(" "),_c('td',[_v("ensure that my calendar remains accurate and reflective of my current commitments and availability.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* ")])]),_v(" "),_c('td',[_v("Lecturer")]),_v(" "),_c('td',[_v("arrange the contacts of the TAs using a module tag")]),_v(" "),_c('td',[_v("send the correct instructions for the module.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("NUS Student")]),_v(" "),_c('td',[_v("see the schedule and interest of my classmates to know who would share the same interest as me")]),_v(" "),_c('td',[_v("meet them for outings/lunch.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("project leader")]),_v(" "),_c('td',[_v("have an interface to see the timetable of my group mates")]),_v(" "),_c('td',[_v("synchronise meetings best fitted for everyone’s schedule.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("international student")]),_v(" "),_c('td',[_v("know my groupmates’ schedules to better arrange my flights (to avoid missing any meeting)")]),_v(" "),_c('td',[_v("successfully accommodate my travel plans.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("introverted NUS student")]),_v(" "),_c('td',[_v("arrange meetings with my new groupmates without interacting with them")]),_v(" "),_c('td',[_v("comfortably initiate group collaboration and fulfil project requirements.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Moddie")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC01 - Add a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a contact to the address book.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Format of the entered contact is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message: Values not accepted.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"use-case-uc02-delete-a-contact"}},[_c('strong',[_v("Use case: UC02 - Delete a contact")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#use-case-uc02-delete-a-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a contact in the address book.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message: Contact not found in address book.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - Edit a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit contact of a specific person in the address book.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook edits contact information of the specific person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message: Contact not found in address book.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. Format of the entered new contact is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. AddressBook shows an error message: Update values not accepted.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 - List all contacts")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts in the address book.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows the list of all contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Find contacts of a specific person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a person with the enetred keyword in name.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows founded persons.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The entered keyword is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. AddressBook shows an error message: Values not accepted.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. There is no matched result")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook shows a message: Contacts not found.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Help")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to read guidance.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows guidance page.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC07 - Exit")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to exit the programme.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook exits.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC08 - Add schedule")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add an event with contact from specified date with time.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the event to the specific contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The entered datetime format is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message: The date format provided is invalid. Format: yyyy-MM-dd HH:mm")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The entered index is invalid")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. AddressBook shows a message: The person index provided is invalid")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Module")]),_v(": A slot in the day used for lesson")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 15:32:03 GMT+8]")])])])}
}];
